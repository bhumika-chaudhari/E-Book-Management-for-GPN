...
$sqlYears = "SELECT DISTINCT year FROM notes_auto WHERE department = 'Automobile'";
...
$sqlSubjects = "SELECT DISTINCT subject FROM notes_auto WHERE department = 'Automobile' AND year = ?";
...
$sqlBooks = "SELECT year, title, description, pdf_path FROM notes_auto WHERE department = 'Automobile'";
if ($selectedYear) {
    $sqlBooks .= " AND year = ?";
}
if ($selectedSubject) {
...
<head>
    ...
    <title>Notes Library For Automobile Department</title>
...
<li><a href="../notes.html"><i class="fas fa-arrow-left"></i> Back</a></li>
    ...
    <header>
        <h1>Notes Library For Automobile Department</h1>
